...
- **Store credit wallet** — turns cashback into a real balance, auto-applied at checkout.
- **Referral** — shareable links; reward referrer + friend on the friend's first order.
- **Birthday coupons** · **expiry-reminder emails** (daily WP-Cron).

### Merchandising & ops
- **Front-end coupon wall** shortcode + Gutenberg block · **one-click templates** (40+)
- **Reports** — per-coupon usage + total discount, plus a revenue / daily-trend overview.
...
Every coupon action is registered as a **WordPress Ability** (31 of them), reachable from:
