...
final class Catalog {
	...
	public static function all(): array {
		return array(
			...
			array(
				'id'       => 'nth_third_free',
				'category' => 'bonus',
				'label'    => __( '每三件最便宜免費', 'moforcoupon' ),
				'desc'     => __( '購物車每滿 3 件,最便宜的一件免費(套用後到「第 N 件折扣」分頁指定商品 / 分類)。', 'moforcoupon' ),
				'type_key' => 'moforcoupon_nth_item',
				'requires' => 'nthitem',
				'prefix'   => 'NTH3FREE',
				'native'   => array(
					'discount_type' => 'moforcoupon_nth_item',
					'amount'        => 0,
					'description'   => __( '每三件最便宜免費', 'moforcoupon' ),
				),
				'meta'     => array(
					Keys::NTH_N            => '3',
			...
			array(
				'id'       => 'nth_third_30off',
				'category' => 'bonus',
				'label'    => __( '每三件第三件七折', 'moforcoupon' ),
				'desc'     => __( '購物車每滿 3 件,最便宜的一件打七折(套用後到「第 N 件折扣」分頁指定商品 / 分類)。', 'moforcoupon' ),
				'type_key' => 'moforcoupon_nth_item',
				'requires' => 'nthitem',
				'prefix'   => 'NTH3',
				'native'   => array(
					'discount_type' => 'moforcoupon_nth_item',
					'amount'        => 0,
					'description'   => __( '每三件第三件七折', 'moforcoupon' ),
				),
				'meta'     => array(
					Keys::NTH_N            => '3',
	...
	public static function module_label( string $slug ): string {
		$map = array(
			...
			'nthitem'       => __( '第 N 件折扣', 'moforcoupon' ),
			'mixmatch'      => __( '任選優惠(Mix & Match)', 'moforcoupon' ),
